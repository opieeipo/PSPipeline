...
| **Combine** | **Join (Inner, Left, Right, Full outer)** (hash join, key-collision-safe), Union/Append (stack 2+ inputs, column-aligned), Aggregate (Count, Sum, Average, Min, Max, First with Group By) |
